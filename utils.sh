...
npx sequelize-cli model:generate --name Accounts --attributes email:string,password:string,id_roles:integer
npx sequelize-cli model:generate --name Customers --attributes fidelityPoints:string
npx sequelize-cli model:generate --name Employeds --attributes lastname:string,firstname:string
npx sequelize-cli model:generate --name Roles --attributes type:string
